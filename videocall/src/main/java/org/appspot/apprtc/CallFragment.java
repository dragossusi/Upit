...
public class CallFragment extends Fragment {
  ...
  public void onStart() {
    ...
    if (args != null) {
      String contactName = args.getString(CallActivity.Companion.getEXTRA_ROOMID());
      contactView.setText(contactName);
      videoCallEnabled = args.getBoolean(CallActivity.Companion.getEXTRA_VIDEO_CALL(), true);
      captureSliderEnabled = videoCallEnabled
          && args.getBoolean(CallActivity.Companion.getEXTRA_VIDEO_CAPTUREQUALITYSLIDER_ENABLED(), false);
    }
    if (!videoCallEnabled) {
